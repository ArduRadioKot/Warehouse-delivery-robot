...
Обновлённый интерфейс работающего локального сервиса на демонстрационных данных. Каталог роботов содержит заданные вручную статусы.
...
Редактор показывает действия пронумерованными карточками: только текст команды, без декоративных картинок. Перестановка и удаление — компактные SVG-кнопки. В шапке сохранён исходный логотип `logo.png`, на карте склада — исходное изображение дрона `drone.png`.
...
- [ESP8266 robot AP](NO-ROS-ROBOT/esp8266_robot_ap/esp8266_robot_ap.ino) — мост Wi-Fi с передачей команд по UART.
...
![Архитектура WDR: браузер, Flask, карта, робот и дрон](docs/architecture.svg)
