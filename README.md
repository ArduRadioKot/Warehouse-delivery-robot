...
**WDR — основной проект.** В него интегрирован сценарий визуального программирования: выбор точек, последовательности перемещений и работы с подъёмником, сохранение и загрузка программ. Исполнение адаптировано под HTTP-протокол ESP8266 из WDR.
